...
#   <M Stoetzl>,<11/26/2023>,<Created Script>
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    ...
    ChangeLog:
    - M Stoetzl, 11/26/2023,  Created the class.
    """
...
class Student(Person):
    """
        ...
        M Stoetzl,Created Class & added properties & private attributes
        """
...
# TODO add the setter for course_name (Done)
    ...
    def course_name(self, value: str):
        try:  # using a try block to capture when an input cannot be changed to a float
            ...
            raise ValueError("Course name must not be only a value.")
